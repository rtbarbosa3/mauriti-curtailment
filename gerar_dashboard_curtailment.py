...
“RESTRICAO_COFF_EOLICA_DETAIL_{year}*{month:02d}.csv”)
URL_DETAIL_UFV = (f”{ONS_BASE}/restricao_coff_fotovoltaica_detail_tm/”
“RESTRICAO_COFF_FOTOVOLTAICA_DETAIL*{year}*{month:02d}.csv”)
URL_CONS_EOL = (f”{ONS_BASE}/restricao_coff_eolica_tm/”
“RESTRICAO_COFF_EOLICA*{year}*{month:02d}.csv”)
URL_CONS_UFV = (f”{ONS_BASE}/restricao_coff_fotovoltaica_tm/”
“RESTRICAO_COFF_FOTOVOLTAICA*{year}_{month:02d}.csv”)
...
def *carrega_mes(url_tpl: str, source: str, kind: str,
year: int, month: int, cache_dir: Path,
cfg: dict, today: date) -> pd.DataFrame | None:
sub = *ensure_dir(cache_dir / “ons” / kind / source)
url = url_tpl.format(year=year, month=month)
dest = sub / f”{kind}*{source}*{year}_{month:02d}.csv”
